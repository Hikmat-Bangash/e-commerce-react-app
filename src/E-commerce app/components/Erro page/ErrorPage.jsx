...
import './erropage.css'
const ErrorPage = () => {
 // use navigation for back button
 ...
 const handleClick = ()=>{
  ...
  return (
    ...
    <div class="text text-center" >
     ...
     <div className="butttons me-2 d-flex" style={{width: "100%",justifyContent: "center", }}>
    <span className='btn btn-outline-primary py-0' onClick={handleClick} style={{marginRight: "10px"}}>back</span>
    
    <Link to='/' className='btn btn-outline-primary py-0 px-1'>home </Link>
